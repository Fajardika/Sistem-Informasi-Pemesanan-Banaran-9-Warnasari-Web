...
$pemesanan = query("SELECT * FROM data_pemesanan WHERE keterangan='Proses' OR keterangan='Selesai'");
...
<body class="background_menu">
    ...
    <div class="table-responsive pb-3">
      ...
      <h6 class="mt-2 mb-2 text-danger fst-italic">*Daftar pemesanan diatas adalah semua daftar pemesanan dengan keterangan <b>Proses</b> dan <b>Selesai</b></h6>
      </div> 
    </div>
    </div>
    </div>
