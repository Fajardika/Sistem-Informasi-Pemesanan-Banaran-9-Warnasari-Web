...
$pemesanan        = query("SELECT * FROM data_pemesanan WHERE keterangan='Proses' ORDER BY tanggal_pemesanan ASC");
$detail_pemesanan = query("SELECT * FROM data_pemesanan WHERE keterangan='Proses'");
...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-lg-6">
    <div id="top">
      <h2 class="pt-5 text-center" id="sub_judul2">Koki Restoran</h2>
      ...
      <div class="row row-cols-1 row-cols-md-2 row-cols-sm-2 g-1">
        ...
        <div class="col" id="left">
          ...
          <div class="card">
            <img src="../img/menu_antriann.png" class="card-img" alt="..." style="box-shadow: 0px 0px 10px 5px var(--brand2)">
          </div>
          </a>
        </div>
        <div class="col" id="right">
...
<div class="modal fade" id="pemesanan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header text-center" id="background_modal">
                <h5 class="modal-title" id="sub_judul5">Daftar Antrian</h5>
                <a href="index.php" class="nav-link btn-close  btn-close-white ms-auto" aria-label="Close"></a>
              </div>
              <div class="mb-3 mt-3 ms-3 me-3">
              ...
              <!-- Looping Table -->
                ...
                <?php foreach( $pemesanan as $row) : ?>
                  ...
                  <td class="col-sm-2"><?= $row["keterangan"] ?></td>
                  <td class="col-sm-1">
                  <div class="text-center">
                    <a class="btn btn-sm rounded-pill text-white" id="btn_user" href="koki.php?kode_pemesanan=<?=$row['kode_pemesanan'];?>"><i class="bi bi-search"></i></a>
                  </td>                      
                  </tr>
                <?php endforeach ?>
              </tbody>
              ...
              <h6 class="mt-2 mb-2 text-danger fst-italic">*Daftar pemesanan diatas adalah daftar pemesanan dengan keterangan <b>Proses</b></h6>
              </div>
              </div>
          </div>
        </div>
